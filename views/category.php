...
if(preg_match('/\?/', end($exploded))) {
    $last = explode('?', end($exploded));
    $categoryId = $last[0];
} else {
...
$count = $articles->getCount($categoryId);
...
if (intval($categoryId) < 1) {
    ...
    foreach($categories as $categoryId => $title) {
        ?>
            <div>
                <a href="/articles/category/<?php echo $categoryId; ?> "><?php echo $title;?></a>
            </div>
        <?php 
    } ?>
            </div>
...
$allArticles = $articles->getAllArticlesByCategoryWithLimit($categoryId, $offset, $limit);

?>

<html>
    <head>
        <title>Mini Blog - Category <?php echo $categories[$categoryId]; ?></title>
        <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css" integrity="sha384-Vkoo8x4CGsO3+Hhxv8T/Q5PaXtkKtu6ug5TOeNV6gBiFeWPGFN9MuhOf23Q9Ifjh" crossorigin="anonymous">
    </head>
    <body>
        ...
        <div class="container" style="padding-top: 20px">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="/">Home</a></li>
                    <li class="breadcrumb-item"><a href="/articles">Articles</a></li>
                    <li class="breadcrumb-item"><a href="/articles/category">Category</a></li>
                    <li class="breadcrumb-item active" aria-current="page"><?php echo $categories[$categoryId];?></li>
                </ol>
            </nav>
                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col">
                            <div class="card-block px-2">
                                ...
                                ?>
                                <a href=""><h6 class="card-subtitle mb-2 text-muted"><?php echo $categories[$categoryId]; ?></h6></a>
                ...
                <nav aria-label="" style="margin-top:20px">
                    <ul class="pagination">
                        <?php for ($i = 1; $i <= $pages; $i++) { ?>
                            <li class="page-item"><a class="page-link" href="/articles/category/<?php echo $categoryId;?>?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                        <?php } ?>
                    </ul>
                </nav>
            <?php } ?>
